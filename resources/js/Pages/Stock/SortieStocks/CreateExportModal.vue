...
function exportPdf() {
  window.open(route('sortie-stocks.export', exportForm.data()), '_blank')
}
</script>
...
<template>
  <Modal ref="exportModalRef">
    ...
    <div class="mb-5 border-b border-slate-100 pb-4">
      <h2 class="text-lg font-bold text-istaht-navy">Exporter la fiche des sorties</h2>
      <p class="mt-1 text-sm text-slate-500">
        Sélectionnez la période et, si besoin, une catégorie pour filtrer les sorties de stock.
      </p>
    </div>
