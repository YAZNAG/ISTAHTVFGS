...
<div class="doc-title-bar">
    ...
    <div class="doc-title">Fiche Technique de Collectivité</div>
...
<div class="info-grid">
    ...
    <div class="info-col info-col-right">
        <div class="info-row"><div class="info-lbl">Chef de cuisine :</div><div class="info-val"><strong>{{ $fiche->responsable }}</strong></div></div>
...
<div class="signatures">
    ...
    <div class="sig-cell"><div class="sig-label">Le Chef de cuisine</div><div class="sig-line">Nom &amp; Signature</div></div>
</div>
